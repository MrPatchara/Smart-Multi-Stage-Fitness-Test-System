...
const int irSensorA = 2;  // ✅ เซ็นเซอร์ IR
...
void setupWiFiAndMQTT() {
    ...
    if (!wifiManager.startConfigPortal("ESP32-Setup #1A")) {
...
void setup() {
    ...
    pinMode(irSensorA, INPUT_PULLUP);  // ✅ ป้องกัน floating
...
void loop() {
    ...
    int irState = digitalRead(irSensorA);
